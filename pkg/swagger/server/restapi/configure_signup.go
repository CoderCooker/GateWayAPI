...
import (
	...
	"github.com/LeetCode/systemdesign/inmemoryfilesystem/rest-api/pkg/swagger/server/restapi/operations"
	"github.com/LeetCode/systemdesign/inmemoryfilesystem/rest-api/pkg/swagger/server/restapi/operations/user"
)

//go:generate swagger generate server --target ../../server --name Signup --spec ../../swagger.yml --principal interface{} --exclude-main

func configureFlags(api *operations.SignupAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.SignupAPI) http.Handler {
